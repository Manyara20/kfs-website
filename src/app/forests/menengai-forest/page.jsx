          ...
          >
            ...
            {activeTab === "attractions" && (
              <section>
                ...
                <p className="   font-normal text-black leading-[1.8] text-[0.9rem] mb-6" style={{ fontSize: `${fontSize * 0.9}px` }}>
                ...
                <h3 className="   font-semibold text-[#0f5a28] text-xl mb-3 mt-6" style={{ fontSize: `${fontSize * 0.95}px` }}>
                  Photo Gallery
                </h3>
